                ...
                <div class="about__info">
                    <div class="about__сhief-editor">
                        <img
                            ...
                            src="https://insight-rsvpu.usite.pro/konovalov_a.a..jpg"
            ...
            <div class="col-md-12 order-md-2">
                ...
                <div class="double-list">
                    ...
                    <div class="double-list__item">
                        ...
                        <ul class="double-list__list">
                            <li class="double-list__list-item">
                                Профессионально-педагогическое образование: современные тенденции развития;
                            </li>
                            <li class="double-list__list-item">
                                Методология и методика профессионально-педагогического образования;
                            </li>
                            <li class="double-list__list-item">
                ...
                <ol class="base-list">
                    <li>
                        <p class="base-list__text">
                            Статьи должны освещать результаты исследований и (или) практический опыт и содержать информацию, открытую для печати и представляющую научный и практический интерес. Каждая статья должна обладать научной новизной.
                        </p>
                        <p class="base-list__text">
                            Содержание статьи должно включать следующие <span class="bold">обязательные элементы</span> актуальность, цель и исследовательские вопросы (для обзорных и теоретических статей обязательна гипотеза), обзор литературы, методы и подход к исследованию, результаты исследования и заключение (ответы на поставленные вопросы).
                        </p>
                        <p class="base-list__text">
                            Статьи предоставляются на русском или английском языках.
                        </p>
                        <p class="base-list__text">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <p class="base-list__text">
                                    Фамилия И. О., звание, должность, место работы <i class="primary">на русском и английском языках</i>, электронная почта;
                                </p>
                            </li>
                            <li>
                                <p class="base-list__text">
                            ...
                            <li>
                                <p class="base-list__text">
                                    аннотацию объемом до 500 п.з. <i class="primary">на русском и английском языках</i>. Аннотация – сжатое реферативное изложение содержания публикации, содержащее структурные части (введение, цель, методология и методы, результаты, научная новизна и практическая значимость);
                                </p>
                            </li>
                            <li>
                                <p class="base-list__text">
                                    ключевые слова (5–7 слов или словосочетаний) <i class="primary">на русском и английском языках</i>;
                                </p>
                            </li>
                            <li>
                                <p class="base-list__text">
                            ...
                            <li>
                                <p class="base-list__text">
                                    рисунки должны иметь подрисуночную подпись. Схемы дожны быть набраны в MS Word (если нет возможности набрать в программе Visio, которая входит в пол­ный пакет Microsoft); фотографии должны быть отсканированы с хорошим раз­ре­ше­нием (300 точек на дюйм) и не только внедрены в файл, но и предоставлены от­дель­ным графическим файлом в формате *.jpg, *.tif, *.png, графики (диаграммы) должны быть подкреплены оригинальным файлом MS Exel.
                                </p>
                            </li>
                            <li>
                                <p class="base-list__text">
                                    список литературы должен содержать все цитируемые в тексте работы в алфавитном порядке.
                                    При ссылке на литературный источник в тексте приводится порядковый номер работы
                                    ...
                                    Список литературы приводится на русском языке, в соответствии с тре­бо­ва­ниями ГОСТ Р 7.0.100–2018.
                                    Список литературы должен содержать не менее <i class="primary">10 источников</i>,
                                    из которых не менее 50% опубликованы в <i class="primary">последние 5 лет, 20% – иностранные</i>.
                                    Ссылки на нормативные документы оформляются в виде подстраничных ссылок, вынесенных в сноску.
                                    Запрещено цитирование в виде перечисления работ. Каждая ссылка должна быть обоснована контекстом.
                                </p>
                            </li>
                        </ul>
                        <div class="d-flex">
                            <a class="btn btn-secondary base-btn mx-auto my-2 rounded-pill" href="/storage/sampleInsight.pdf" target="_blank">
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <p class="base-list__text">
                                    <a class="base-link" href="https://insight-rsvpu.usite.pro/zajavlenie_na_publikaciju_insajt.docx">
