            ...
            <div class="about__layout col-md-12">
                <div class="about__info">
                    <div class="clearfix">
                        ...
                        <h2 class="featurette-heading about__heading">Уважаемые авторы и читатели!</h2>
                        <div class="base-text">
                            <p>
                                Приглашаем принять участие в подготовке очередного номера научного журнала «Инновационная научная современная академическая исследовательская траектория (ИНСАЙТ)».
                            </p>
                            <p>
                                Журнал входит в
                                <a class="base-link" href="/storage/list_of_publications.pdf" target="_blank">Перечень рецензируемых научных изданий ВАК (файл во вложении «Перечень на 19.12»)</a>,
                                в которых должны быть опубликованы основные научные результаты диссертаций на соискание ученых степеней кандидата наук и доктора наук
                            </p>
                            <p>
                                Каждый номер нашего журнала постатейно размещается в библиографической базе данных публикаций российских авторов,
                                расположенной в составе интегрированного научного информационного ресурса
                                <a class="base-link" href="https://www.elibrary.ru/title_about_new.asp?id=74698" target="_blank">eLIBRARY</a>
                                с индексацией в РИНЦ, в базе данных <span class="primary bold">CrossRef</span> с присвоением DOI,
                                а также в каталогах Электронной библиотеки
                                <a class="base-link" href="https://cyberleninka.ru/journal/n/innovatsionnaya-nauchnaya-sovremennaya-akademicheskaya-issledovatelskaya-traektoriya?i=1112210">CyberLeninka.ru</a>.
                            </p>
                            <p>
                    ...
                    <div class="double-list">
                        <div class="double-list__item">
                            <p class="double-list__title">
                                Наш научный журнал принимает материалы для публикации по следующим <span class="primary bold">научным специальностям</span>
                            </p>
                            <ul class="double-list__list">
                                <li class="double-list__list-item no-dots">
                                    <b>Психологические науки:</b>
                                    <p>
                                ...
                                <li class="double-list__list-item no-dots">
                                    ...
                                    <p>
                                        5.8.1. Общая педагогика, история педагогики и образования;<br>
                                        5.8.2. Теория и методика обучения и воспитания (по областям и уровням образования);<br>
                        ...
                        <div class="double-list__item second">
                            <p class="double-list__title">
                                В журнале представлены <span class="primary bold">рубрики:</span>
                            </p>
                            <ul class="double-list__list">
                ...
                <ol class="base-list">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <p class="base-list__text">
                                    Основной текст должен быть разбит на разделы, которым следует дать краткие заголовки. Структурирование текста может зависеть от направленности (эмпирической или теоретической) исследования. Эмпирические исследования должны соответствовать формату IMRAD (введение, обзор литературы, материалы и методы, результаты исследования и обсуждение, заключение). Теоретические исследования могут иметь авторскую логику изложения в соответствии с порядком обсуждения проблемы и аргументации.
                                </p>
                            </li>
                            <li>
                                <p class="base-list__text">
